...
// 打开坐标点详细
export const openWayPointDetailForm = (player, pointName, isAdmin = false, type, returnForm) => {
  const form = new ActionFormData();
...
// 按照玩家名称打开坐标点列表
export const openPlayerWayPointListForm = (player, targetPlayerName, page = 1, returnForm) => {
  const form = new ActionFormData();
